...
//#include "include/usb_function_msd.h"
#include "include/usb_function_cdc.h"
...
ROM USB_DEVICE_DESCRIPTOR device_dsc=
{
	...
	0xABCD,					// Product ID: cooles USB-Pulsoxy
...
{'F','H','T','W',' ','B','M','T',' ','M','i','c','h','a','e','l',' ','H','a','l','l','e','r',' ',' '}
};

//Product string descriptor
ROM struct{BYTE bLength;BYTE bDscType;WORD string[25];}sd002={
sizeof(sd002),USB_DESCRIPTOR_STRING,
{'U','S','B',' ','D','e','m','o','b','o','a','r','d',' ','B','i','o','M','e','d','L','a','b',' ',' '}
};
